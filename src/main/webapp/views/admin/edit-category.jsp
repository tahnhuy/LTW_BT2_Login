        ...
        <div class="form-card">
            ...
            <form action="${edit}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" value="${category.name}" name="name" required />
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="error">Chỉ chấp nhận file ảnh (jpg, png, gif). Để trống nếu không muốn thay đổi ảnh.</div>
                </div>
